...
function handleSaveIdProduct(id) {
  localStorage.setItem("product_id", id);
  window.location.href = "shop-details.html";
}

function handleSaveIdCategory(id) {
...
function redictToListBill() {
  let typeUser = localStorage.getItem("typeUser")
  if (typeUser == 0) {
    window.location.href = "listBillOrderAdmin.html";
  }
  else {
    window.location.href = "listBillOrder.html";
  }
}